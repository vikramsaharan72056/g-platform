                ...
                {games.map((game) => (
                    ...
                    >
                        <div className="game-card-header">
                            ...
                            <div>
                                <h3>{game.name}</h3>
                                <span className="game-card-type">{game.type || 'TABLE'}</span>
                            </div>
                    ...
                    <div className="card-body">
                        <div className="stats-grid">
                            <div className="stat-card mini">
                                ...
                                <div className="stat-value">{gameStats.totalRounds || 0}</div>
                            </div>
                            <div className="stat-card mini">
                                <div className="stat-label">Total Bets</div>
                                <div className="stat-value">{gameStats.totalBets || 0}</div>
                            </div>
                            <div className="stat-card mini">
                                <div className="stat-label">Total Bet Volume</div>
                                <div className="stat-value">{formatCurrency(gameStats.totalBetAmount || 0)}</div>
                            </div>
                            <div className="stat-card mini">
                                <div className="stat-label">House P&L</div>
                                <div className="stat-value" style={{ color: Number(gameStats.housePnl) >= 0 ? '#27ae60' : '#e74c3c' }}>
                                    {formatCurrency(gameStats.housePnl || 0)}
                                </div>
                            </div>
                        </div>
                    </div>
